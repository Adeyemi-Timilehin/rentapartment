        ...
        <div class='col-md-5 col-lg-4'>
          ...
          <div class='card-header'>
              ...
              <div class='card-body'>
                  ...
                  <div>
                  <a href='detailproperty.php?id=<?php echo  $data['property_id'];?>'  class='text-light ml-auto btn btn-success'>view</a>
                  <button class="btn btn-danger mr-2" onclick="document.location.href='rent.php'">Back</button>  
                  </div>
